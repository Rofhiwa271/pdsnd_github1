...
def get_filters():
    ...
    print('\nProject 2! Let\'s Explore US Bikeshare Data!')
    ...
    while True:
      ...
      if city not in ('chicago', 'new york city', 'Washington'):
        print("oops, retry check spelling . Try again.")
        continue
      else:
        break
    ...
    while True:
      ...
      if month not in ('January', 'February', 'March', 'April', 'May', 'June'):
        print("oops, Month between january till june. Try again.")
        continue
      else:
        break
    ...
    while True:
      ...
      if day not in ('Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'):
        print("oops, type monday till sunday . Try again.")
        continue
      else:
        break
